    ...
    <div className="p-6 bg-gray-50 rounded-lg shadow-md">
      ...
      >
        {products.map((product) => (
          <div
            key={product._id}
            className="relative flex flex-col justify-between items-center rounded-lg bg-white shadow-lg transition-transform transform hover:scale-105 duration-300 w-80 mx-auto mb-10 h-[500px]"
            data-aos="fade-up" 
          >
            {product.discount && (

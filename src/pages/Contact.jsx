        ...
        <div className="mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="relative flex text-center flex-col justify-center bg-white p-6 md:p-8 shadow-lg rounded-lg overflow-hidden">
              ...
              <p className="relative text-gray-300 mb-4 text-justify">
                Nuestro equipo está disponible para resolver tus dudas y
                ofrecerte la asistencia que necesites.
              </p>
              <p className="relative text-gray-300 mb-4 text-justify">
                Contáctanos a través de los medios que hemos proporcionado.
              </p>
              <p className="relative text-gray-300 mb-4 text-justify">
                Entendemos que a veces las situaciones pueden ser urgentes, así
                que no dudes en comunicarte con nosotros para obtener una
                respuesta rápida.
              </p>
              <p className="relative text-gray-300 mb-4 text-justify">
                Ya sea que necesites información sobre nuestros productos,
                asistencia técnica, o simplemente tengas alguna consulta,
                estamos aquí para ayudarte.
              </p>
              <p className="relative text-gray-300 mb-4 text-justify">
                Nuestro compromiso es brindarte un servicio excepcional, así que
                tu satisfacción es nuestra prioridad. Recuerda que cada pregunta
                es importante para nosotros.
              </p>
              <p className="relative text-gray-300 font-semibold">

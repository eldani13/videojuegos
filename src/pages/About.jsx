...
function About() {
  ...
  return (
    <div className="bg-gray-100">
      ...
      <section className="bg-cover bg-center h-screen relative" 
        ...
        <div className="flex items-center justify-center h-full bg-black bg-opacity-60 px-4 animate-fade-in">
          <div className="text-center text-white space-y-4">
            <h1 className="text-4xl md:text-5xl font-bold animate-slide-up" data-aos="fade-up">Sobre Nosotros</h1>
            <p className="text-lg md:text-xl max-w-lg mx-auto animate-slide-up-delay" data-aos="fade-up" data-aos-delay="200">
      ...
      <section id="team" className="py-12 md:py-16 bg-gray-50" data-aos="fade-up">
        <div className="mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-12">Conoce a Nuestro Equipo</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 shadow-lg rounded-lg hover:shadow-2xl hover:scale-105 transition-transform duration-300" data-aos="fade-up">
